...
describe("Gilded Rose", function () {
  describe("updateQuality", function () {
    ...
    it("should not set quality below 0 even when sell-in is 0", function () {
      const gildedRose = new Shop([new Item("foo", 0, 0)]);
      const items = gildedRose.updateQuality();
      expect(items[0].quality).to.equal(0);
    });
  ...
  it("should increase backstage pass quality by 2 if sell-in is 6 to 10", function () {
    const gildedRose = new Shop([
  ...
  it("should set backstage pass quality to 50 if addition in quality would surpass 50", function () {
    const gildedRose = new Shop([
